 ...
 *
 * Name : EXT075MI.CalcRateSales
 * Description : The CalcRateSales transaction launch calcul to the EXT075 table.
...
public class CalcRateSales extends ExtendM3Transaction {
  ...
  public CalcRateSales(MIAPI mi, DatabaseAPI database, LoggerAPI logger, ProgramAPI program, UtilityAPI utility, MICallerAPI miCaller) {
    this.mi = mi
  ...
  public void main() {
    ...
    // Recherche fichier cumul assortiment famille
    ...
    EXT076.set("EXFVDT",mi.in.get("FVDT") as Integer)
    if(!TarifCompQueryB.readAllLock(EXT076, 5 ,Delete_EXT076)){

    }
    // Recherche fichier entete tarif EXT080
    iZIPL=""
    iPIDE=""
  ...
  // outDataEXT075 : Retrieve EXT075 and process 1
  ...
  // updateCallBack_CUGEX1 : Maj Nb Lignes GUGEX1
  ...
  // Delete_EXT076 : Delete EXT076
  Closure<?> Delete_EXT076 = { LockedResult lockedResult ->
    lockedResult.delete()
  }
  // updateCallBack_EXT076 : update EXT076
  ...
  // updateCallBack_EXT076_MAJ : update MMO2 EXT076
  ...
  // outData_EXT075_T2 : Retrieve EXT075 process2
  ...
  // outData_MITMAS2 : Retrieve MITMAS in process2
  ...
  //updateCallBack_EXT075 : update EXT075 in process 1
  ...
  private void majEXT076(){
    ...
    DBContainer EXT076_Maj = AxesSimpQueryMajQuery.getContainer()
    EXT076_Maj.set("EXCONO",currentCompany)
    EXT076_Maj.set("EXPRRF",iPRRF)
    EXT076_Maj.set("EXCUCD",iCUCD)
    EXT076_Maj.set("EXCUNO",iCUNO)
    EXT076_Maj.set("EXFVDT",iFVDT as Integer)
    if(!AxesSimpQueryMajQuery.readAll(EXT076_Maj, 5, outData_EXT076)){
