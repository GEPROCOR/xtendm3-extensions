 ...
 *
 * Name : EXT021MI.AddFinalSalesPt
 * Description : Add records to the EXT021 table.
 * Date         Changed By   Description
 * 20210819     RENARN       CMDX06 - Gestion des points de vente
 */
import java.time.LocalDateTime
import java.time.format.DateTimeFormatter
public class AddFinalSalesPt extends ExtendM3Transaction {
  ...
  public AddFinalSalesPt(MIAPI mi, DatabaseAPI database, ProgramAPI program, UtilityAPI utility, LoggerAPI logger) {
    this.mi = mi;
