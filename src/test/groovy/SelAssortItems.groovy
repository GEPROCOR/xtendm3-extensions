 ...
 * Description : Select the items based on the criteria contained in EXT051 table and add records to the EXT052 table.
 ...
 * 20211109     RENARN       EXT800 management has been added
  ...
  public boolean itemSelectionOK() {
    ...
    if(ITTY != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (ITTY == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(BUAR != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (BUAR == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(HIE1 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (HIE1 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(HIE2 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (HIE2 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(HIE3 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (HIE3 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(HIE4 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (HIE4 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(HIE5 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (HIE5 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(CFI1 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (CFI1 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(ITGR != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (ITGR == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(CFI5 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (CFI5 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(CSC1 != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (CSC1 == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(CSNO != 0) {
      ...
      if (EXT051_query.read(EXT051)) {
        ...
        if (CSNO == 1) return false //If the value of the criteria is not found in the selection and criteria is in inclusion (= 1), item is include
      }
    }
    ...
    if(ORGA != 0) {
      if (ORGA == 1 && !orga) return false //If the item is not organic and criteria "Organic" is in inclusion (= 1), item is include
    ...
    if(HALA != 0) {
      if (HALA == 1 && !hala) return false //If the item is not halal and criteria "Halal" is in inclusion (= 1), item is include
    ...
    if(KOSH != 0) {
      if (KOSH == 1 && !kosh) return false //If the item is not kosher and criteria "Kosher" is in inclusion (= 1), item is include
    ...
    if(GLFR != 0) {
      if (GLFR == 1 && !glfr) return false //If the item is not gluten free and criteria "Gluten free" is in inclusion (= 1), item is include
