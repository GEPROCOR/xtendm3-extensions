...
public class LstCertificate extends ExtendM3Transaction {
  ...
  public LstCertificate(MIAPI mi, DatabaseAPI database, LoggerAPI logger, ProgramAPI program) {
    this.mi = mi;
  ...
  Closure<?> outData = { DBContainer EXT130 ->
    orno = EXT130.get("EXORNO")
    ponr = EXT130.get("EXPONR")
    posx = EXT130.get("EXPOSX")
    dlix = EXT130.get("EXDLIX")
    zcid = EXT130.get("EXZCID")
    doid = EXT130.get("EXDOID")
    ...
    mi.outData.put("PONR", ponr as String)
    mi.outData.put("POSX", posx as String)
    mi.outData.put("DLIX", dlix as String)
    mi.outData.put("ZCID", zcid as String)
    mi.outData.put("DOID", doid)
