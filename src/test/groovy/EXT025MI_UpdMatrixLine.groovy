 ...
 *
 * Name : EXT025MI.UpdMatrixLine
 * Description : Update record to the EXT025 table.
 * Date         Changed By   Description
 * 20240821     ALLNIC          CMD40 - Update a Preparation date assortment matrix line
 */
import java.time.LocalDateTime
import java.time.format.DateTimeFormatter

public class UpdMatrixLine extends ExtendM3Transaction {
  ...
  public UpdMatrixLine(MIAPI mi, DatabaseAPI database, LoggerAPI logger, ProgramAPI program) {
    this.mi = mi
  ...
  Closure<?> updateCallBack = { LockedResult lockedResult ->
    ...
    if(mi.in.get("DELY") != null)
      lockedResult.set("EXDELY", mi.in.get("DELY"))
