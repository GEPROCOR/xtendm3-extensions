...
public class GetSchedSetting extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    DBAction query = database.table("EXT820").index("00").selection("EXTX30","EXTX60","EXXCAT","EXSCTY","EXXNOW","EXXTOD","EXXNMO","EXXNTU","EXXNWE","EXXNTH","EXXNFR","EXXNSA","EXXNSU","EXXEMO","EXXETU","EXXEWE","EXXETH","EXXEFR","EXXESA","EXXESU","EXXEMT","EXXRDY","EXXJDT","EXXJTM","EXXSTI","EXFDAT","EXTDAT","EXJSCA","EXPETP","EXTIZO","EXRGDT","EXRGTM","EXLMDT","EXCHNO","EXCHID","EXUUID").build()
