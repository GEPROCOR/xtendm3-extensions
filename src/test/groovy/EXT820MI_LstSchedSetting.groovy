...
public class LstSchedSetting extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    if (mi.in.get("JOID") == null) {
      DBAction query = database.table("EXT820").index("00").selection("EXJOID","EXUSID","EXXVSN","EXTX30","EXTX60","EXXCAT","EXSCTY","EXXNOW","EXXTOD","EXXNMO","EXXNTU","EXXNWE","EXXNTH","EXXNFR","EXXNSA","EXXNSU","EXXEMO","EXXETU","EXXEWE","EXXETH","EXXEFR","EXXESA","EXXESU","EXXEMT","EXXRDY","EXXJDT","EXXJTM","EXXSTI","EXFDAT","EXTDAT","EXJSCA","EXPETP","EXTIZO","EXUUID","EXRGDT","EXRGTM","EXLMDT","EXCHNO","EXCHID").build()
